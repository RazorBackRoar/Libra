...
2. **Maintainer contact** — email the maintainer using the address on their [GitHub profile](https://github.com/RazorBackRoar) with a clear subject such as `SECURITY: L!bra`.
